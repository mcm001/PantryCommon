...
public class GuidingVectorField extends VectorField {
	...
	protected double psi(double t) {
		return t;
	} // FIXME: pass this in constructor, definitely (type is known)

	protected double e(Translation2d here) {
		return psi(surface.f().apply(here));
	} // surface.f is phi from the paper
