...
/**
 * Calculate the movement of a swerve drive's modules from a commanded state.
 * Allows calculation of module motion given a x, y, rotation power
 */
public class SwerveKinematics {
	...
	/**
	 * calculate and cache individual wheel speeds and angles based on a vector and rotation power
	 * @param x the x component of the requested motion
	 * @param y the y component of the requested motion
	 * @param rotate the rotation component of the requested motion
	 */
